...
void addConfigOptions(ConfigImpl *cfg)
{
  ...
  cl = cfg->addList(
              ...
              "C comment), *.py, *.pyw, *.f90, *.f95, *.f03, *.f08, *.f18, *.f, *.for, *.tcl,\n"
              "*.vhd, *.vhdl, *.ucf, *.qsf and *.ice."
             );
  cl->addValue("*.c");
  cl->addValue("*.cc");
  cl->addValue("*.cxx");
  ...
  cs->setDefaultValue("https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/");
  ...
  cb->addDependency("GENERATE_DOCBOOK");
  //---------------------------------------------------------------------------
  ...
  //----
  cfg->addObsolete("XML_SCHEMA");
  //----
  cfg->addObsolete("XML_DTD");
  //----
  cfg->addObsolete("PERL_PATH");
  //----
  cfg->addObsolete("MSCGEN_PATH");
}
