...
class ConfigValues
{
  public:
    ...
    QCString OUTPUT_TEXT_DIRECTION;
    ...
    QCString HTML_FORMULA_FORMAT;
    int      FORMULA_FONTSIZE;
    bool     FORMULA_TRANSPARENT;
    QCString FORMULA_MACROFILE;
    bool     USE_MATHJAX;
    ...
    QCString LATEX_EMOJI_DIRECTORY;
    bool     GENERATE_RTF;
    QCString RTF_OUTPUT;
    bool     COMPACT_RTF;
    bool     RTF_HYPERLINKS;
