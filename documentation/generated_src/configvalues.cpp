...
ConfigValues::ConfigValues() : m_map(257)
{
  ...
  m_map.insert("OUTPUT_TEXT_DIRECTION",new InfoString(&ConfigValues::OUTPUT_TEXT_DIRECTION));
  ...
  m_map.insert("JAVADOC_BANNER",new InfoBool(&ConfigValues::JAVADOC_BANNER));
  ...
  m_map.insert("OPTIMIZE_OUTPUT_SLICE",new InfoBool(&ConfigValues::OPTIMIZE_OUTPUT_SLICE));
  ...
  m_map.insert("EXTRACT_PRIV_VIRTUAL",new InfoBool(&ConfigValues::EXTRACT_PRIV_VIRTUAL));
...
#endif
#if USE_LIBCLANG
  m_map.insert("CLANG_DATABASE_PATH",new InfoString(&ConfigValues::CLANG_DATABASE_PATH));
#endif
  ...
  m_map.insert("HTML_DYNAMIC_MENUS",new InfoBool(&ConfigValues::HTML_DYNAMIC_MENUS));
  ...
  m_map.insert("HTML_FORMULA_FORMAT",new InfoString(&ConfigValues::HTML_FORMULA_FORMAT));
  ...
  m_map.insert("FORMULA_MACROFILE",new InfoString(&ConfigValues::FORMULA_MACROFILE));
  ...
  m_map.insert("LATEX_MAKEINDEX_CMD",new InfoString(&ConfigValues::LATEX_MAKEINDEX_CMD));
  ...
  m_map.insert("LATEX_EMOJI_DIRECTORY",new InfoString(&ConfigValues::LATEX_EMOJI_DIRECTORY));
  ...
  m_map.insert("XML_NS_MEMB_FILE_SCOPE",new InfoBool(&ConfigValues::XML_NS_MEMB_FILE_SCOPE));
...
void ConfigValues::init()
{
  ...
  OUTPUT_TEXT_DIRECTION     = ConfigImpl::instance()->getEnum(__FILE__,__LINE__,"OUTPUT_TEXT_DIRECTION");
  ...
  JAVADOC_BANNER            = ConfigImpl::instance()->getBool(__FILE__,__LINE__,"JAVADOC_BANNER");
  ...
  OPTIMIZE_OUTPUT_SLICE     = ConfigImpl::instance()->getBool(__FILE__,__LINE__,"OPTIMIZE_OUTPUT_SLICE");
  ...
  EXTRACT_PRIV_VIRTUAL      = ConfigImpl::instance()->getBool(__FILE__,__LINE__,"EXTRACT_PRIV_VIRTUAL");
...
#endif
#if USE_LIBCLANG
  CLANG_DATABASE_PATH       = ConfigImpl::instance()->getString(__FILE__,__LINE__,"CLANG_DATABASE_PATH");
#endif
  ...
  HTML_DYNAMIC_MENUS        = ConfigImpl::instance()->getBool(__FILE__,__LINE__,"HTML_DYNAMIC_MENUS");
  ...
  HTML_FORMULA_FORMAT       = ConfigImpl::instance()->getEnum(__FILE__,__LINE__,"HTML_FORMULA_FORMAT");
  ...
  FORMULA_MACROFILE         = ConfigImpl::instance()->getString(__FILE__,__LINE__,"FORMULA_MACROFILE");
  ...
  LATEX_MAKEINDEX_CMD       = ConfigImpl::instance()->getString(__FILE__,__LINE__,"LATEX_MAKEINDEX_CMD");
  ...
  LATEX_EMOJI_DIRECTORY     = ConfigImpl::instance()->getString(__FILE__,__LINE__,"LATEX_EMOJI_DIRECTORY");
  ...
  XML_NS_MEMB_FILE_SCOPE    = ConfigImpl::instance()->getBool(__FILE__,__LINE__,"XML_NS_MEMB_FILE_SCOPE");
